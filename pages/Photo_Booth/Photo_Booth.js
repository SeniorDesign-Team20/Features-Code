    ...
    const handleCameraType = () => {
      ...
      const handleTakePicture = async () => {
        if (cameraRef) {
          ...
          alert("PHOTO SUCCESSFULLY TAKEN. Click filter to filter or download to download.")
        }
      };
      ...
      const handlePickImage = async () => {
        ...
        if (!result.cancelled) {
          ...
          alert("IMAGE SUCCESSFULLY CHOSEN. Click filter to filter or download to download.")
        }
      };
